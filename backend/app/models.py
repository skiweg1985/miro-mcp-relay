...
class ProviderApp(Base):
    ...
    oauth_dynamic_client_registration_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    oauth_registration_endpoint: Mapped[str | None] = mapped_column(String(512), nullable=True)
    oauth_registration_auth_method: Mapped[str] = mapped_column(String(32), default="none")
    is_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
