        ...
        with SessionLocal() as db:
            ...
            db.add(
                DelegationGrant(
                    ...
                    encrypted_delegated_credential=encrypt_text(graph_credential),
            ...
            db.add(
                DelegationGrant(
                    ...
                    encrypted_delegated_credential=encrypt_text(miro_credential),
        ...
        with SessionLocal() as db:
            ...
            db.add(
                DelegationGrant(
                    ...
                    encrypted_delegated_credential=encrypt_text(solo_credential),
                    allowed_access_modes_json=dumps_json(["direct_token"]),
                    scope_ceiling_json=dumps_json(["Mail.Read"]),
                    environment="test",
                )
