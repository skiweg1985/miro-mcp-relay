...
import { api } from "../api";
import { Card, DataTable, Field, FormActions, InlineForm, PageIntro, SecretPanel, StatusBadge } from "../components";
  ...
  return (
    <>
      ...
      <div className="two-column">
        ...
        <Card title="Grant access" description="Issue a time-bound credential for a service and integration.">
          <InlineForm title="New access" description="The person must have connected the integration in their workspace when required." onSubmit={handleSubmit}>
            <Field label="Person">
              <>
                <input
                  list="access-users"
            ...
            <FormActions pending={pending} submitLabel="Create" />
          </InlineForm>
        </Card>
      </div>
    </>
