...
import { api } from "../api";
import { Card, DataTable, Field, FormActions, InlineForm, PageIntro, SecretPanel } from "../components";
  ...
  return (
    <>
      ...
      <div className="two-column">
        ...
        <Card title="New service" description="Creates a key and secret for a trusted application.">
          <InlineForm title="Create service" description="Choose which integrations this caller may use." onSubmit={handleSubmit}>
            <Field label="Key">
